...
# NOTE: we build our own static sqlite3 library with custom flags
...
target_include_directories(${PROJECT_NAME}
  PRIVATE
    ${sqlite_STATIC_INCLUDE_DIRS}  # TEMP:REM: when global shared sqlite is built with our flags
)

target_link_libraries(${PROJECT_NAME}
  PRIVATE
    ${local_sqlite_LDFLAGS}  # TEMP:CHG: replace by "PkgConfig::sqlite" when global sqlite is built with our flags
)
